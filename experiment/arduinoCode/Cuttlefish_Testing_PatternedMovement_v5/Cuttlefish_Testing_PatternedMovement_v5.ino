...
//  pulseLow =  6000- (115);      //clockwise @ 1/8Hz
  ...
  pulseHigh = 6000+ (070);      //counter clockwise @ 1/10Hz
  pulseLow =  6000- (95);      //clockwise @ 1/10Hz
...
/***********************************************/
void stopExperiment() {
  Serial.println("Experiment Canceled by experimenter.");   
  testStarted=0;
  ...
  stopServoPulses();
  Serial.println("  ");  Serial.println("  ");  Serial.println("  "); 
  Serial.println("Experiment Stopped.   Experiment Stopped.   Experiment Stopped.   ");     
  Serial.println("Experiment Stopped.   Experiment Stopped.   Experiment Stopped.   ");     
  Serial.println(" ");     
...
void cw360() {
  ...
  tMotorOn=30000;     //experiment=1000.  calibration=10000, 20000 or 30000
...
void patternedMovement() {
  ...
  if(direction==0)    cw360();
  if(direction==1)    ccw360();
